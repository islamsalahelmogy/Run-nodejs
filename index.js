...
const util2=require('./utilities/util2.js');
//const currentFile= __filename.split('\\').splice(5).join('/');
//const currentFile= __filename.normalize(); normailze path remove double slash or dots
//const currentFile= __filename;
//console.log('NODE RAN',currentFile);
//path.dirname(require.main.filename)  project path
console.log(path.dirname(require.main.filename));
console.log(util1.sum([1,2,3,4]));
